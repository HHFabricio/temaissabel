...
<head>
	...
	<title>Neoflex PBX - {$PAGE_NAME}</title>
...
<div class="login-container">
	...
	<div class="login-header login-caret">
		...
		<div class="login-content">
			...
			<img src="{$WEBPATH}themes/{$THEMENAME}/images/issabel_logo_mini.png" width="300" alt="Issabel logo" />
...
{/if}
			...
			<div class="login-bottom-links">
				...
				<a href="http://www.neoflex-telecom.com.br" style="text-decoration: none;" target='_blank'>Neoflex Telecom</a> Licenciado SOB <a href="http://www.opensource.org/licenses/gpl-license.php" style="text-decoration: none;" target='_blank'>GPL</a>. 2006 - {$currentyear}.</div>
